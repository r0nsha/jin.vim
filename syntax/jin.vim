...
syn match jinIdentifier "_\?[a-z][\-_a-zA-Z0-9][_a-zA-Z0-9]\+" nextgroup=@jinArguments

" Constants
syn match jinConstant "_\?[A-Z][\-_a-zA-Z0-9][_a-zA-Z0-9]*"
...
" Keywords
syn match jinKeyword '\.\@<!\<\(let\|else\|type\|use\|mut\|return\|true\|false\)\>'
